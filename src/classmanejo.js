...
export class Conduccion {
    ...
    Movimientos(serieDeMovimientos){
       for(let i=0;i<serieDeMovimientos.length;i++){
        if (this._coordenadas.orientacion=="N") {
            MovimientoConOrientacionNorte(serieDeMovimientos[i]);
        }
        if (this._coordenadas.orientacion=="E") MovimientoConOrientacionEste(serieDeMovimientos[i]);
        if (this._coordenadas.orientacion=="O") MovimientoConOrientacionOeste(serieDeMovimientos[i]);
        }
    }
    ...
    MovimientoConOrientacionNorte(cadena) {
        ...
        this._posActualF=nuevaFila;
        this._posActualC=nuevaColumna;
